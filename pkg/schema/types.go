...
// NavigationAlert is a compliance obligation alert generated by the navigation engine.
// Alerts are persisted to .attest/history/navigation/ and surfaced by 'attest navigate'.
type NavigationAlert struct {
	...
	Status      string     `yaml:"status" json:"status"` // "unknown" | "met" | "partial" | "unmet"
	GeneratedAt time.Time  `yaml:"generated_at" json:"generated_at"`
}
